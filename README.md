# Sistema-de-Locadora-Modelagem-e-Consultas-SQL-em-MySQL
...
2.Desenvolvimento (Criação e modelagem das tabelas)
...
insert into veiculos (modelo,marca,ano,cor) values
('onix','chevrolet','2018','preto'),
('onix','chevrolet','2019','branco'),
('onix','chevrolet','2019','prata'),
('ka','ford','2018','prata'),
('ka','ford','2019','branco'),
('fit','honda','2020','prata'),
('fit','honda','2019','branco'),
('fit','honda','2020','preto'),
('gol','volkswagem','2017','branco'),
('gol','volkswagen','2020','preto'),
('gol','volkswagen','2019','prata');


insert into locacoes (id_cliente,id_veiculo,data_retirada,data_devolucao) values
(1,2,'2026-03-02','2026-03-15'),
(5,3,'2025-05-03','2025-06-10'),
(6,2,'2026-04-10','2026-04-20'),
(6,4,'2026-02-01','2026-03-20'),
(1,10,'2025-10-03','2025-10-21'),
(1,11,'2025-07-10','2025-07-26'),
(5,11,'2025-06-02','2025-06-19'),
(3,6,'2025-08-04','2025-08-16'),
(2,7,'2026-08-11','2026-09-19'),
(2,5,'2026-11-12','2026-12-03'),
(3,1,'2025-03-12','2025-04-11'),
(7,7,'2025-01-05','2025-01-25'),
(2,9,'2025-06-12','2025-06-29'),
(3,11,'2025-09-11','2025-09-21'),
(8,8,'2026-03-21','2026-03-30');
...
2.1 DESENVOLVIMENTO DAS QUERIES

2.1.1 (Consulta utilizando LEFT JOIN)
...
2.1.2 (Consulta com INNER JOIN, GROUP BY e HAVING)
...
2.1.3 (Agrupamento por marca de veículo)
...
2.1.4 (Window Functions - Indicadores por marca)
...
2.1.5 (Window Functions - Participação percentual)
...
2.1.6 (Window Functions - Amplitude das diárias)
